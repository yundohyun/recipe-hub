...
public class CaloriesAPI {
  ...
  private String buildUrl(int pageNo, int numOfRows, String foodName) {
    ...
    if (foodName != null && !foodName.isBlank()) {
      sb.append("&FOOD_NM_KR=").append(URLEncoder.encode(foodName, StandardCharsets.UTF_8));
    }
    return sb.toString();
  }

  // HTTP GET 호출 및 JSON 문자열 받기
  private String callApi(int pageNo, int numOfRows, String foodName) throws IOException {
